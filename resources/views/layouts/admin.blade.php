...
<!-- Modal Structure -->
  ...
  <div id="modal5" class="modal" style="width: 30%;min-height: 75%;">
    ...
    <h4 style="text-align: center;">Register Team Leader</h4><br><br>
      ...
      <div class="row">
        <div class="input-field col s12">
          <input placeholder="" id="password" name="tname" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input placeholder="" name="tel" id="password" type="text" class="validate">
      ...
      <input type="hidden" name="role" value="teamlead">
      <div class="row">
        <div class="input-field col s12">
      ...
      <div class="modal-footer">
      <button type="submit" class=" modal-action modal-close waves-effect waves-green  btn btn-flat">Register</button>
    </div>
      ...
      <div class="row">
        <div class="col s2" style="margin-right: 3%;">
          <ul class="nav">
            <a href="{{ url('/') }}" style="color: black;"><li>All Bookings</li></a>
            <li class="modal-trigger" href="#modal5">Register Team Leader</li>
            <a href="/viewusers" style="color: black;"><li>View All Users</li></a>
